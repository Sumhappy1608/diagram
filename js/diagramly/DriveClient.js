...
DriveClient = function(editorUi)
{
	...
	if (this.ui.editor.chromeless && !this.ui.editor.editable && urlParams['rt'] != '1')
	{
		...
		this.appId = window.DRAWIO_GOOGLE_VIEWER_APP_ID || '81345318337';
		this.clientId = window.DRAWIO_GOOGLE_VIEWER_CLIENT_ID || '81345318337-gqg4mi05rja54ivskbuft8dfca6pjn6g.apps.googleusercontent.com';
		this.scopes = ['https://www.googleapis.com/auth/drive.readonly',
			'https://www.googleapis.com/auth/userinfo.profile'];
	}
	else
	{
		this.appId = window.DRAWIO_GOOGLE_APP_ID || '';
		this.clientId = window.DRAWIO_GOOGLE_CLIENT_ID || '';
	}
